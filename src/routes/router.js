...
import {searchEmployeeByIdHandler,deleteEmployeeByIdHandler,modifyEmployeeByIdHandler} from '../controllers/employeeController.js';
...
import {authenticate,isEmployee} from'../utils/auth.js';
const router = Router();
...
router.get('/employee/:id',searchEmployeeByIdHandler);
router.delete('/employee/:id',deleteEmployeeByIdHandler);
router.patch('/employee/:id',modifyEmployeeByIdHandler);

router.post('/service',verify,isEmployee,createServiceHandler);
