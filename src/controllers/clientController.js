...
const searchClientByIdHandler = (req, res) => {
  const { id } = req.params;
...
const modifyClientByIdHandler = (req, res) => {
  ...
  searchClientById(id, (error, results, fields) => {
    ...
    if(nuevoCliente.name){cliente.nombre = nuevoCliente.name;}
    if(nuevoCliente.lastname){cliente.apellido = nuevoCliente.lastname;}
    if(nuevoCliente.adress){  cliente.direccion = nuevoCliente.adress;}
    if(nuevoCliente.dni){cliente.dni = nuevoCliente.dni;}
    if(nuevoCliente.date){ cliente.fecha_nac = nuevoCliente.date;}
    if(nuevoCliente.nationality){  cliente.nacionalidad = nuevoCliente.nationality;}
    if(nuevoCliente.phone){cliente.celular = nuevoCliente.phone;}
    if(nuevoCliente.email){cliente.email = nuevoCliente.email;}
